...
RD = 73, PD = 85, L1 = 30, L2 = 120, z_home = 105, servo_min = -90, servo_max = 90,servo_mult = 55 ,
...
*/
const int servo_pin[6] = {9,3, 5, 11, 6, 10}, servo_zero[6] = {1500, 1500, 1500, 1500, 1500, 1500};
/*
